export const
    pfx = 'gjs-',
    cmdWidget = 'widget-code',
    ticker = 'price-ticker',
    tickerHtml = `<div class="pt-container">
    ...
    widget = 'widget',
    deeplink = 'deeplink',
    deeplinkHtml = `<form action="" class="deeplink">
    ...
    profileHtml = `<div class="wrapper">
        <div class="profile-card js-profile-card">
            <div class="profile-card__img">
                <img alt="profile card">
            </div>
            <div class="profile-card__cnt js-profile-cnt">
                <div class="profile-card__name">John Doe</div>
                <div class="profile-card__txt">Occupation from <strong>Place</strong></div>
